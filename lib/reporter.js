var tape = require('tape'),
    ...
    trimmable = function(str) { return str; };

// Stub trimmable for tape on old browsers without modifying
// String prototype, which could affect test results
if(!''.trim) {
  var trim = function() { return this.replace(/^\s\s*/, ''); };
  trimmable = function (str) {
    str.trim = trim;
    return str;
  };
}
    ...
    harness(' ', function(t) {
      nodeunit.runModules(modules, {
        ...
        moduleStart: function(name) {
          t.comment(trimmable(name.toString()));
        },
